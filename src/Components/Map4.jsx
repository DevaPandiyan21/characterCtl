    ...
    <group {...props} dispose={null} position={[10,-2,0]} > 
      <group name="Clothes_rack_8" position={[0, 1.827, 0]} rotation={[-Math.PI / 2, 0, 0]} scale={0.024}>
        <group name="Object_6_7" position={[-23.032, 260.432, -5.813]} rotation={[0, 0, -3.133]} scale={0.604}>
          <mesh name="Object_14" geometry={nodes.Object_14.geometry} material={materials.greyPlastic} />
          <mesh name="Object_15" geometry={nodes.Object_15.geometry} material={materials.holes} />
          <mesh name="Object_16" geometry={nodes.Object_16.geometry} material={materials.whiteMetal} />
        </group>
      </group>
      <group name="B1_Teal_9" position={[3.29, 7.184, 5.46]} rotation={[0, -1.54, 0]} scale={[0.822, 0.822, 0.009]}>
        <mesh name="Object_18" geometry={nodes.Object_18.geometry} material={materials.Teal} />
        <mesh name="Object_19" geometry={nodes.Object_19.geometry} material={materials.Face_Outlines} />
        <mesh name="Object_20" geometry={nodes.Object_20.geometry} material={materials.Face_Mat} />
      ...
      <group name="B1_Teal001_15" position={[-0.666, 2.041, 4.385]} rotation={[-Math.PI, 0, -Math.PI]} scale={[0.211, 0.211, 0.002]}>
        <mesh name="Object_31" geometry={nodes.Object_31.geometry} material={materials.Teal} />
        <mesh name="Object_32" geometry={nodes.Object_32.geometry} material={materials.Face_Outlines} />
        <mesh name="Object_33" geometry={nodes.Object_33.geometry} material={materials.Face_Mat} />
      ...
      <group name="Cube001_26" position={[-2.906, 1.746, -3.9]} rotation={[0, Math.PI / 2, 0]} scale={[0.445, 0.325, 0.877]}>
        <mesh name="Object_56" geometry={nodes.Object_56.geometry} material={materials.Materiale} />
      ...
      <group name="Cube002_30" position={[-2.91, 1.746, -5.816]} rotation={[0, Math.PI / 2, 0]} scale={[0.445, 0.325, 0.877]}>
        <mesh name="Object_59" geometry={nodes.Object_59.geometry} material={materials.Materiale} />
      ...
      <group name="Cube003_31" position={[1.839, 1.746, -5.816]} rotation={[0, Math.PI / 2, 0]} scale={[0.445, 0.325, 0.877]}>
        <mesh name="Object_62" geometry={nodes.Object_62.geometry} material={materials.Materiale} />
